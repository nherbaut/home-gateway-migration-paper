...
The paper highlights a migration path towards full Home Gateway virtualization and proves its concept through a real implementation and a simulated evaluation on a practical use case related to video streaming.
\end{abstract}
