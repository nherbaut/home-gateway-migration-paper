...
We implemented a very simple provisioning policy, based on the number of requests for the same resource received in a 10 minutes rolling window. If the number is above the threshold, the video is cached at the regional POP level and clients can download the video from there.
